...
function key_start_pressed(){
	...
	*/
	...
	buffer_write(server_buffer, buffer_u8, NETWORK.game_round);
	buffer_write(server_buffer, buffer_u8, GAME_ROUND.number);
	buffer_write(server_buffer, buffer_u8,global.game_round);
	...
	buffer_write(server_buffer, buffer_u8, PLAYER_CONFIG.role);
	buffer_write(server_buffer, buffer_u8, ds_map_find_value(socket_to_instanceid, socket).player_role);
	...
	buffer_write(server_buffer, buffer_u8, NETWORK.player_config);
	buffer_write(server_buffer, buffer_u8, PLAYER_CONFIG.role);
	buffer_write(server_buffer, buffer_u8, ds_map_find_value(socket_to_instanceid, socket^3).player_role);
	...
	buffer_write(server_buffer, buffer_u8, STATUS.conducter_mode_start);
